...
internal sealed class PolyfillJsonStringEnumConverter<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields)] TEnum> :
#else
internal sealed class PolyfillJsonStringEnumConverter<TEnum> :
#endif
    JsonStringEnumConverter<TEnum> where TEnum : struct, Enum
{
#if !NET9_0_OR_GREATER
    /// <summary>
    /// Initializes a new instance of the <see cref="PolyfillJsonStringEnumConverter{TEnum}"/> class.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public PolyfillJsonStringEnumConverter() :
...
/// in versions prior to .NET 9. It works together with <see cref="PolyfillJsonStringEnumConverter{TEnum}"/>

...
public static class Models
{
    ...
    public const string Gemini2_0FlashLite = "models/gemini-2.0-flash-lite";
    public const string Gemini1_5Flash = "models/gemini-1.5-flash";
    public const string Gemini1_5Flash8B = "models/gemini-1.5-flash-8b";
    public const string Gemini1_5Pro = "models/gemini-1.5-pro";
    public const string GeminiEmbeddingExp = "models/gemini-embedding-exp";
    public const string Imagen3 = "models/imagen-3.0-generate-002";
    public const string Veo2 = "models/veo-2.0-generate-001";
    public const string Gemini2_0FlashLive = "models/gemini-2.0-flash-live-001";
}